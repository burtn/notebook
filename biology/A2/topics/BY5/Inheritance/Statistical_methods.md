The Chi-squared statistical test can be used to determine if observed results are close to those which are expected or if something is happening to affect the results other than chance.
